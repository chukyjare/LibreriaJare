...
//		initComponent();
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(btnLimpiar, GroupLayout.PREFERRED_SIZE, 49, Short.MAX_VALUE)
					.addGap(48))
		);
	...
	private boolean validarCampos() {
		return Validaciones.validaLetras(txtAutor.getText())
				&& Validaciones.validaLetras(txtEditorial.getText()) && Validaciones.validaFloat(txtPrecio.getText().substring(0, txtPrecio.getText().length()-1));
	}
}
